    ...
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="bg-cover border-white/10 relative flex flex-col items-start justify-between overflow-hidden border-r bg-[url(../assets/bg-stars.svg)] px-28 py-16">
        ...
        >
          ...
          <p className="text-sm max-w-[240px] leading-snug">
        ...
        <div className="space-y-5">
          ...
          <a
            href=""
            className="inline-block rounded-full bg-green-500 px-5 py-3 font-alt uppercase leading-none text-gray-900 hover:bg-green-600"
          >
            CADASTRAR LEMBRANÇA
          </a>
        </div>
